...
This collection of scripts and notebooks written in `python` are related to computing and visualizing Persistent Homology using different distance metrics generated by expanding circles (n-spheres) and ellipsoids.

<img src="images/figures_01-12.png" />
